...
--
-- Host: localhost:3306
-- Generation Time: May 04, 2026 at 12:49 AM
...
(131, b'0', '<p><span style=\"background-color:rgb(254,254,254);color:rgb(20,20,20);font-size:18px;\">Hi anh em, đang loanh quanh trần cung, mình đi đạp mái chỉ thích được thổi kèn chứ k có nhu cầu đút vào lắm, xin anh em list hàng em nào chuyên bộ môn bú liếm để check phát, MB hệ giá rẻ càng tốt ạ</span></p>', '2026-05-01 07:48:14.033712', b'0', 0, 'Đang gần HQV , anh em cho xin hàng checkerviet nào chuyên dịch vụ thổi kèn với', 0, 1, 4, NULL),
...
(143, b'1', '<p>Kiểu bơi này dễ nhất</p>', '2026-05-03 09:18:00.995785', b'0', 0, 'Kiểu bơi này dễ nhất', 20, 1, 4, NULL);
...
(4, '$2a$10$vZ8cyER2eHAdBzyqf/w5uuxMoWLz7tfqq4pPoztnsjb7hZjRuPWfC', 'user02'),
(5, '$2a$10$PWHubAcanB47WaEkH0PnZuPBlj4SJxcuKs0/LvXlI1W9mEDsEsS5a', 'user03');
